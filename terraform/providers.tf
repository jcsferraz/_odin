...
module "network_vpc_dev" {
  ...
  public_subnets = [
    ...
    { cidr_blocks = "12.0.0.0/23", zone = "us-east-1d", name = "subnet-dev-d-pub" },
    { cidr_blocks = "12.0.2.0/23", zone = "us-east-1e", name = "subnet-dev-e-pub" },
    { cidr_blocks = "12.0.4.0/23", zone = "us-east-1f", name = "subnet-dev-f-pub" }
  ]
  ...
  private_subnets = [
    ...
    { cidr_blocks = "12.0.6.0/23",  zone = "us-east-1d", name = "subnet-dev-d-priv" },
    { cidr_blocks = "12.0.8.0/23", zone = "us-east-1e", name = "subnet-dev-e-priv" },
    { cidr_blocks = "12.0.10.0/23", zone = "us-east-1f", name = "subnet-dev-f-priv" }
  ]
}
